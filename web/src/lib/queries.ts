...
export const HERO_TRIP_QUERY = defineQuery(/* groq */ `
  *[
  ...
  | order(startDate asc, _id asc)[0] {
    ...
    pricePerPerson,
    currency,
    previousTripsGalleryImageOne { asset },
    previousTripsGalleryImageTwo { asset },
    previousTripsGalleryImageThree { asset },
    previousTripsGalleryImageFour { asset },
    previousTripsGalleryImageFive { asset },
    previousTripsGalleryImageSix { asset },
    previousTripsGalleryImageSeven { asset },
    previousTripsGalleryImageEight { asset },
    ...
    "shortVideoOneUrl": shortVideoOneFile.asset->url,
    shortVideoOneFallbackImage { asset },
    "shortVideoTwoUrl": shortVideoTwoFile.asset->url,
    shortVideoTwoFallbackImage { asset },
    "shortVideoThreeUrl": shortVideoThreeFile.asset->url,
    shortVideoThreeFallbackImage { asset },
    "shortVideoFourUrl": shortVideoFourFile.asset->url,
    shortVideoFourFallbackImage { asset },
